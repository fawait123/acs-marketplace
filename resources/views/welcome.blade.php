        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                ...
                                <img class="img-fluid w-100" src="{{ asset('frontend') }}/img/category/c1.jpg"
                                    alt="">
                                <a href="{{ asset('frontend') }}/img/category/c1.jpg" class="img-pop-up"
                                    target="_blank">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                ...
                                <img class="img-fluid w-100" src="{{ asset('frontend') }}/img/category/c2.jpg"
                                    alt="">
                                <a href="{{ asset('frontend') }}/img/category/c2.jpg" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                ...
                                <img class="img-fluid w-100" src="{{ asset('frontend') }}/img/category/c3.jpg"
                                    alt="">
                                <a href="{{ asset('frontend') }}/img/category/c3.jpg" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                ...
                                <img class="img-fluid w-100" src="{{ asset('frontend') }}/img/category/c4.jpg"
                                    alt="">
                                <a href="{{ asset('frontend') }}/img/category/c4.jpg" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-deal">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{ asset('frontend') }}/img/category/c5.jpg"
                            alt="">
                ...
                <div class="col-lg-6 no-padding exclusive-right">
                    <div class="active-exclusive-product-slider">
                        ...
                        <div class="single-exclusive-slider">
                            <img class="img-fluid" src="{{ asset('frontend') }}/img/product/e-p1.png"
                                alt="">
                            <div class="product-details">
                                <div class="price">
                                    <h6>$150.00</h6>
        ...
        <div class="container">
            <div class="row">
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('frontend') }}/img/brand/1.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('frontend') }}/img/brand/2.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('frontend') }}/img/brand/3.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('frontend') }}/img/brand/4.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('frontend') }}/img/brand/5.png"
                        alt="">
                </a>
            </div>
        </div>
